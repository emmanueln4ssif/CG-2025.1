...
plane.material.color.set(0xFFF1C1); // siena (marrom-terra)
scene.add(plane);

//Adicionando plataformas
const area1 = buildPlatform(scene, 100, 120, 8, { x: 160, y: 0, z: 150 }, 15, 8, 1, 0x7FFFD4);
const area2 = buildPlatform(scene, 100, 120, 10, { x: 10, y: 0, z: 150 }, 15, 8, 1, 0xE1A4A0);
const area3 = buildPlatform(scene, 100, 120, 8, { x: -150, y: 0, z: 150 }, 15, 8, 1, 0xC3D3F1);
const area4 = buildPlatform(scene, 100, 320, 8, { x: 10, y: 0, z: -150 }, 15, 8, 1, 0xB9D7A9);
